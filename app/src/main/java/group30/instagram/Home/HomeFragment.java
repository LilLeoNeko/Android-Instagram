package group30.instagram.Home;
...
import group30.instagram.Utils.MainfeedListAdapter;
import group30.instagram.Utils.StoriesRecyclerViewAdapter;
import group30.instagram.models.Comment;
...
//        mListView.requestUpdate();
    ...
    private void getFriendsStories(){
        ...
        for(int i = 0; i < mUserAccountSettings.size(); i++){
            ...
            final int count = i;
            Query query = FirebaseDatabase.getInstance().getReference().child(getString(R.string.dbname_stories)).child(mUserAccountSettings.get(i).getUser_id());
